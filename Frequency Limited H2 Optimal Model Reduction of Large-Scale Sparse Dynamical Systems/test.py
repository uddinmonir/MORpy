...
def call():
        ...
        #file = sio.loadmat('E:/STUDY MATERIAL/MONIR SIR/ALL/data/1st_order/dae/index1/bps_1142.mat')
        file = sio.loadmat('E:/STUDY MATERIAL/MONIR SIR/ALL/data/1st_order/dae/index1/bps_1450.mat')
        #file = sio.loadmat('E:/STUDY MATERIAL/MONIR SIR/ALL/data/1st_order/dae/index1/bps_1693.mat')
        ...
        B = B1 - J2 * csc_matrix(spsolve(J4, B2)).T
